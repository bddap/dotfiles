...
in {
  ...
  # Convention: nix/nixos/local/default.nix. Never committed, but NOT
  # machine-local: ./install-to-disk carries the dir to new machines
  # and its modules are baked into the closure it installs.
  imports =
